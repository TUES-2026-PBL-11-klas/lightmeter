...
const styles = StyleSheet.create({
  ...
  evLabel: { color: '#ffd700', fontWeight: '800', fontSize: 10, letterSpacing: 1 },
  shutterValue: { color: '#fff', fontSize: 100, fontWeight: '100', fontFamily: 'monospace' },
  apertureValue: { color: '#fff', fontSize: 32, fontWeight: '300' },
  isoLabel: { color: '#aaa', fontSize: 14, fontWeight: '700', marginTop: 10 },
  divider: { width: 40, height: 2, backgroundColor: '#ffd700', marginVertical: 20 },
});